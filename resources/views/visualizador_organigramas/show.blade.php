<x-app-layout>
    @section('breadcrumbs')
      <li class="text-sm">
          <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="{{ route('visualizador_organigramas.index') }}">
    ...
    <div class="max-w-[120rem] px-4 py-2 sm:px-6 lg:px-8 lg:py-2 mx-auto">
        <div id="org-chart-view-container" data-organigrama-id="{{ $organigrama->id }}">
            <script>
