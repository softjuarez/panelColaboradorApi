...
<body>
    <div class="container">
        <h1>Solicitud de Licencia Aceptada</h1>
        <p>Estimado/a {{ $solicitud->usuario->name }},</p>
        <p>Nos complace informarle que su solicitud de <strong>{{ $solicitud->tipo_licencia->nombre }}</strong> ha sido <strong>aceptada</strong>.</p>
