<x-app-layout>
    @section('breadcrumbs')
      <li class="text-sm">
          <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="{{ route('autoriza_licencias.index') }}">
            ...
            <div id="card-type-tab-preview" role="tabpanel" aria-labelledby="card-type-tab-item-1">
                <div class="bg-white rounded-xl rounded-t-none shadow p-4 sm:p-7 dark:bg-slate-900">
                    ...
                    <div class="mt-5 flex justify-end gap-x-2">
                        <a href="{{ route('autoriza_licencias.index') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                            {{ __('Cancel') }}
                        </a>
                    </div>
                </div>
    ...
    <div id="hs-autorizar" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog" aria-labelledby="hs-autorizar-label">
        ...
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
            ...
            <div class="flex gap-x-4 md:gap-x-7">
                ...
                <div class="grow">
                    ...
                    <p class="text-gray-700 text-sm">
                        Estás a punto de autorizar permanentemente la licencia con el id <strong>{{ $licencia->id }}</strong>.
                    </p>
                    ...
                    <div class="bg-white p-3 rounded-md mt-3">
                        ...
                        <ul class="list-disc list-inside text-gray-700 text-sm pl-4">
                            <li>Que los datos de la licencia sean correctos.</li>
                            <li>Que los dias solicitados estén debidamente justificados.</li>
                            <li>Que la licencia cumpla con las políticas y procedimientos establecidos.</li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <a href="{{ route('autoriza_licencias.autorizar', $licencia) }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-teal-500 text-white hover:bg-teal-600 disabled:opacity-50 disabled:pointer-events-none">
                Autorizar
            </a>
            </div>
        </div>
    ...
    <div id="hs-rechazar" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog" aria-labelledby="hs-rechazar-label">
        ...
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
            ...
            <form action="{{ route('autoriza_licencias.rechazar', $licencia)}}" method="post">
                <div class="p-4 sm:p-10 overflow-y-auto">
                    <div class="flex gap-x-4 md:gap-x-7">
                        <!-- Icon -->
                        ...
                        <div class="grow">
                            ...
                            <p class="text-gray-700 text-sm">
                                Estás a punto de rechazar la licencia con el numero <strong>{{ $licencia->id }}</strong>.
                            </p>
                            <p class="text-gray-700 text-sm mt-2">
                                🔒 <strong>Esta acción es irreversible.</strong> Una vez confirmada, no podrás deshacerla. Por favor, procede con precaución.
                            </p>
                            <div class="bg-white p-3 rounded-md mt-3">
                                ...
                                <ul class="list-disc list-inside text-gray-700 text-sm pl-4">
                                    ...
                                    <li>Confirmar que la licencia no cumple con los requisitos necesarios.</li>
                                </ul>
                            </div>
