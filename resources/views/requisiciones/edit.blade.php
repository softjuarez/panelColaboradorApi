<x-app-layout>
    @section('breadcrumbs')
    <li class="text-sm">
        <a class="flex items-center text-gray-500" href="{{ route('requisiciones.index') }}">
    ...
    <div class="max-w-[100rem] grid grid-cols-1 md:grid-cols-2 gap-4 sm:px-6 lg:px-8 lg:py-2 mx-auto">
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            <form id="formulario_central" method="post" action="{{ route('requisiciones.update', $requisicion) }}">
                @csrf
                ...
                <div class="grid sm:grid-cols-12 gap-2 sm:gap-3 my-2">
                    ...
                    <div class="sm:col-span-9">
                        <x-select-search
                            ...
                            :disabled="$requisicion->ESTATUS != 'A' ? true : false"
                            />
                    ...
                    <tr>
                        ...
                        <td class="h-px w-px whitespace-nowrap">
                          <div class="px-6 py-1">
                            ...
                            <button onclick="alertDetalle({{ $detalle->NUMERO }})" type="button" class="inline-flex items-center gap-x-2 text-sm ml-2 py-1 xl:py-0 font-semibold rounded-lg border border-transparent text-red-600 hover:text-red-800 disabled:opacity-50 disabled:pointer-events-none hs-dark-mode-active:text-red-500 hs-dark-mode-active:hover:text-red-400">Eliminar</button>
                            @endif
                            </div>
                        </td>
                    </tr>
    ...
    <script>
        ...
        function obtenerDetalleDeReqD(detalleId)
        {
            detalleSelected = detalleId;
            crearOEditarC = 1;
            document.getElementById('errorContainerD').innerHTML = '';
