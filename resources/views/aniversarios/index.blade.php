...
<h2 style="text-align:center;">🎉 Aniversarios del Mes 🎉</h2>
<div id='calendar'></div>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            events: "{{ route('aniversarios.listado') }}",
            eventClick: function (info) {
                document.getElementById('nombre-aniversario').textContent = info.event.title;
