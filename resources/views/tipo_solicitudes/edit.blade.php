    ...
    <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
      <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 dark:text-gray-400">
          {{ __('Formulario para editar tipos de solicitudes') }}.
        </p>
      </div>
  
      <form method="post" action="{{ route('tipo_solicitudes.update', $tipo_solicitud) }}">
        @csrf
        <!-- Grid -->
