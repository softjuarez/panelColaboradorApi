            ...
            <div class="flex gap-x-7 py-3 first:pt-0 last:pb-0">
                ...
                <div class="flex-1">
                    ...
                    <div class="flex items-center gap-x-3">
                        ...
                        <!-- WhatsApp Button -->
                        <a href="https://wa.me/50230281454"
                           target="_blank"
                           class="inline-flex items-center justify-center w-8 h-8 text-white bg-green-500 rounded-full hover:bg-green-600 transition-colors duration-200 shadow-sm hover:shadow-md"
