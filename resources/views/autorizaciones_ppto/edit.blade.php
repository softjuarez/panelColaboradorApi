<x-app-layout>
    @section('breadcrumbs')
    <li class="text-sm">
        <a class="flex items-center text-gray-500" href="{{ route('autoriza-ppto.index') }}">
            ...
            {{ __('Autorizacion de Requisiciones Presupuesto') }}
        </a>
    </li>
    <li class="text-sm">
    ...
    <div class="max-w-[100rem] grid grid-cols-1 md:grid-cols-2 gap-4 sm:px-6 lg:px-8 lg:py-2 mx-auto">
                ...
                <div class="mt-2">
                   <table class="dark:text-gray-200 text-sm">
                      ...
                      <tr>
                          ...
                          <td colspan="3" class="px-6">{{ !empty($requisicion->COMENTARIO2) ? Str::of($requisicion->COMENTARIO2)->title() : 'Sin especificar' }}</td>
                      </tr>
                      <tr>
        ...
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            <form id="formulario_central" method="post" action="{{ route('autoriza-ppto.update', $requisicion) }}">
                @csrf
                ...
                <div class="flex items-start justify-between">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="{{ route('autoriza-ppto.index') }}" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-white dark:hover:bg-gray-800 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        {{ __('Cancel') }}
                        </a>
                        <button id="formulario_central_boton"  type="submit" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                        {{ __('Save') }}
                        </button>
                    </div>
                </div>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                  <thead>
                        <tr>
                            ...
                            <th scope="col" colspan="2" class="px-6 py-1 text-center">
                  ...
                  <tbody id="tabla-detalles" class="divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tr>
                        ...
                        <td class="h-px w-px whitespace-nowrap">
                            <div class="px-6 py-1 text-right">
                                <span class="text-sm text-gray-600">{{ number_format($detalle->CANT_AUT1 * $detalle->PU, 2, '.', ',') }}</span>
                            </div>
                        </td>
          ...
          <div class="w-full max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl">
            ...
            <div class="flex justify-between items-center gap-x-2 py-3 px-4 border-t">
                ...
                <div class="flex justify-end gap-x-2">
                  ...
                  <button id="save-cotizacion" type="button" onclick="generarDetalleD()" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600">
                    Guardar
                  </button>
                  @endif
                </div>
    ...
    <div id="hs-danger-alert-p" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog" aria-labelledby="hs-danger-alert-label">
        ...
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
            ...
            <button type="button" class="size-8 inline-flex justify-center items-center gap-x-2 rounded-full border border-transparent bg-gray-100 text-gray-800 hover:bg-gray-200 focus:outline-none focus:bg-gray-200 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-700 dark:hover:bg-neutral-600 dark:text-neutral-400 dark:focus:bg-neutral-600" aria-label="Close" data-hs-overlay="#hs-danger-alert-p">
                <span class="sr-only">Close</span>
            ...
            <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-gray-200 bg-white text-gray-800 shadow-sm hover:bg-gray-50 disabled:opacity-50 disabled:pointer-events-none focus:outline-none focus:bg-gray-50 dark:bg-transparent dark:border-neutral-700 dark:text-neutral-300 dark:hover:bg-neutral-800 dark:focus:bg-neutral-800" data-hs-overlay="#hs-danger-alert-p">
                Cancelar
            </button>
            <button type="button" class="py-2 px-3 inline-flex items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-red-500 text-white hover:bg-red-600 disabled:opacity-50 disabled:pointer-events-none" onclick="deleteDetalleP()">
                Eliminar
            </button>
            </div>
        </div>
    ...
    <div id="hs-autorizar" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog" aria-labelledby="hs-autorizar-label">
        ...
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
            ...
            <form action="{{ route('autoriza-ppto.autorizar', $requisicion)}}" method="post">
                <div class="p-4 sm:p-10 overflow-y-auto">
                    <div class="flex gap-x-4 md:gap-x-7">
                        <!-- Icon -->
                        ...
                        <div class="grow">
                            ...
                            <div class="p-4">
                                ...
                                <div class="sm:col-span-2">
                                    ...
                                    <textarea name="motivo_autoriza" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 dark:bg-neutral-900 dark:border-neutral-700 dark:placeholder-neutral-500 dark:text-neutral-400" value="{{ old('motivo_autoriza') }}" placeholder="Motivo del autoriza" autofocus="" required></textarea>
    ...
    <div id="hs-rechazar" class="hs-overlay hidden size-full fixed top-0 start-0 z-[80] overflow-x-hidden overflow-y-auto" role="dialog" aria-labelledby="hs-rechazar-label">
        ...
        <div class="relative flex flex-col bg-white border shadow-sm rounded-xl overflow-hidden dark:bg-neutral-900 dark:border-neutral-800">
            ...
            <form action="{{ route('autoriza-ppto.rechazar', $requisicion)}}" method="post">
                <div class="p-4 sm:p-10 overflow-y-auto">
                    <div class="flex gap-x-4 md:gap-x-7">
                        <!-- Icon -->
    ...
    <script>
        ...
        function obtenerDetalle(crearOEditarDetalle, detalleId = 0)
        {
            ...
            if (crearOEditarDetalle == 1) {
                ...
                fetch("{{ route('detalle.jefe.edit', ':detalle') }}".replace(':detalle', detalleId))
        ...
        function generarDetalleD()
        {
            if (clickEnabled) {
              ...
              const datos = JSON.stringify({
                ...
                prioridad: document.getElementById('prioridad_req_c').value,
        ...
        function generarDetalle()
        {
            if (clickEnabled) {
              ...
              if (crearOEditar == 1){
                  ...
                  url = "{{ route('detalle.jefe.update', ':detalle') }}";
                  url = url.replace(':detalle', detalleSelected);
              }
                ...
                for(var i = 0; i <= data.length -1 ; i++) {
                    document.getElementById("tabla-detalles").insertAdjacentHTML("beforeend", `
                        <tr>
                          ...
                          <td class="h-px w-px whitespace-nowrap">
                              <div class="px-6 py-1 text-right">
                                  <span class="text-sm text-gray-600">${ parseFloat(data[i].PU * data[i].CANT_AUT1).toFixed(2) }</span>
                              </div>
                          </td>
        ...
        function limpiarCamposC()
        {
            ...
            document.getElementById('prioridad_req_c').value = 0
        ...
        async function actualizarTotal() {
            try {
                const response = await fetch("{{ route('autoriza-ppto.obterner_total', $requisicion) }}");
    ...
    <script>
        ...
        document.getElementById('formulario_central').addEventListener('submit', function() {
            const submitButton = this.querySelector('button[type="submit"]');
            if (submitButton) {
                handleSubmitButtonLoading(submitButton.id, 'Enviando...');
            }
        });

        function handleSubmitButtonLoading(idObject, loadingText = 'Procesando...')
        {
            let button = document.getElementById(idObject)
        ...
        function handleSubmitButtonStopLoading(idObject, loadingText = 'Guardar')
        {
            let button = document.getElementById(idObject)
