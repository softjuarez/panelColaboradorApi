<x-app-layout>
    ...
    <li class="text-sm">
        <a class="flex items-center text-sm text-gray-500 hover:text-blue-600 focus:outline-none focus:text-blue-600 dark:focus:text-blue-500" href="#">
            ...
            {{ __('Reporte de Ficha de Responsabilidad') }}
        </a>
    </li>
    @endsection
    ...
    <div class="max-w-[100rem] px-4 py-2 sm:px-6 lg:px-8 lg:py-2 mx-auto">
        <div class="bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            <div class="mb-8">
                ...
                {{ __('Reporte Ficha de Responsabilidad') }}
                </h2>
                <p class="text-sm text-gray-600 dark:text-gray-400">
                {{ __('Puedes generar reporte de Ficha de Responsabilidad.') }}
                </p>
            </div>
            ...
            <div class="grid sm:grid-cols-12 gap-2 sm:gap-6">
                ...
                <div id="sede-container" class="sm:col-span-3">
                    <label for="sede" class="inline-block text-sm text-gray-800 mt-2.5 dark:text-gray-200">
                        {{ __('Sede*') }}
                    </label>
                </div>

                <div id="sede-select-container" class="sm:col-span-9">
                    <div class="relative">
                        <select id='sede' data-hs-select='{
                            "hasSearch": true,
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            generarReporteBtn.addEventListener('click', function(event) {
                ...
                if ({{ auth()->user()->fichaActiva() }} == 0){
                    event.preventDefault();
                    alert('Debes tener una ficha seleccionada.');
                    exit;
                }

                let url = "{{ route('responsabilidad.generar', [':fechaI', ':fechaF', ':sede']) }}";
