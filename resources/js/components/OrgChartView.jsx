...
function OrgChart({ organigramaId }) {
    ...
    const handleFichaChange = (selectedOption) => {
        setFormDataGroupMembers({
            ...
            ficha_id: selectedOption ? selectedOption.value : null
        });
    };
        ...
        <div class="w-full bg-white rounded-xl shadow p-4 sm:p-7 dark:bg-slate-900">
            ...
            <div class="flex items-start justify-between mb-2">
                ...
                <div class="flex items-start">
                    <button onClick={() => handleFilterChange('all')} className="mr-2 z-10 top-4 left-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">D</button>
                    <button onClick={() => handleFilterChange('resumido')} className=" z-10 top-4 left-4 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">R</button>
                </div>
            </div>
